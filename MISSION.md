...
**Current Status:**
Project initialized. Next.js 15 app structure is being set up. Prisma schema is defined with models for User, Project, Income, Expense, FundTransaction, ReserveTransaction, MemberLoan, Advance, and Settlement.
